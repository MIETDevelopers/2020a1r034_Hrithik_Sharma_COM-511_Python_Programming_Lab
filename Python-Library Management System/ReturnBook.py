...
issueTable = "issueBooks" #Issue Table
bookTable = "addBooks" #Book Table
...
def returnn():
    ...
    try:
        ...
        if int(bid) in allBid:
            ...
            messagebox.showinfo("Error","Unable to return book with the specified Book ID")
    except:
    ...
    print(bid in allBid)
    print(status)
    updateStatus = "update "+bookTable+" set status = 'avail' where bookid = '"+bid+"'"
    try:
